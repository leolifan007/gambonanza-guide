...
ADJACENT Gambits reward **clustering** your pieces:

```
Good:  [ ][X][ ]    X is adjacent to center
       [X][O][X]    O is the Gambit piece
       [ ][X][ ]    4 pieces can benefit

Bad:   [O][ ][ ]    O is isolated
       [ ][ ][ ]    No adjacent pieces means no triggers
       [ ][ ][X]    Only 1 piece benefits
```

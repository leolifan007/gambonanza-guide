...
|---|---|---|---|
| **4×4 Blitz** | 16 squares | &lt;5 min | Learning mechanics |
| **5×5 Standard** | 25 squares | 5-10 min | Normal runs |
| **6×6 Tactical** | 36 squares | 15+ min | Advanced gambit play |

</div>

<div class="pro-tip">
  <strong>Only 10h+ players know:</strong> 4×4 boards don't just teach you the game ?they're also the best economy farms. A fast 4×4 win in under 3 minutes gives you the same stock reward as a 15-minute 6×6 grind. Speed runners farm 4×4 exclusively for stock.
</div>
...
Single-player only with boss AI. No multiplayer at launch ?Gambonanza is designed as a solo roguelike experience. Developer Blukulélé has hinted at potential leaderboard features in future updates.
...
<div class="callout callout-danger">
  <strong>⚠️ THE RARITY TRAP</strong><br>
...
**The math:** A Common Gambit that synergizes with your build provides 2-3× value per turn. A Legendary that's anti-synergistic provides 0.5× value. Simple: synergy > price tag, always.
...
<p>Not required, but they make the fight 2-3× easier. Worth grabbing if you see them in the shop.</p>
...
**Yes.** Launched May 1, v1.1.0. Developer Blukulélé has confirmed post-launch content updates ?more Gambits, bosses, and possibly additional modes. The meta will shift.

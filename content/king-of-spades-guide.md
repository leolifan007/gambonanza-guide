...
**King of Spades** is a mid-to-late boss that appears around board size 5×5 or 6×6. His core mechanic — **Piece Teleport** — lets him swap any two of your pieces on the board every 3 turns.
...
<p class="schema-caption">Before (Turn 2→3) vs After Teleport (Turn 3). Red outlines highlight swapped pieces (Queen a4 ↔ Rook d5).</p>
...
- **Fortress** (Makes a 2×2 area teleport-proof)

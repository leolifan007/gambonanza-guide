...
The community-agreed second-hardest boss after Grandmaster. Normal clear rate around 15%. The difficulty isn't damage â€?it's the teleport. One wrong piece placement and your whole board falls apart.

<div class="meta-rating">

  <span class="meta-badge meta-s">S</span>

  <span class="meta-label">Hardest non-final boss. Without King's Counter, win rate drops below 10%.</span>

</div>

## Boss Overview

**King of Spades** is a mid-to-late boss that appears around board size 5Ã—5 or 6Ã—6. His core mechanic â€?**Piece Teleport** â€?lets him swap any two of your pieces on the board every 3 turns.
...
| Win Rate (Avg) | ~15% â†?40%+ with prep |
...
## Teleport Mechanic â€?Exact Breakdown
...
<p class="schema-caption">Before (Turn 2â†?) vs After Teleport (Turn 3). Red outlines highlight swapped pieces (Queen a4 â†?Rook d5).</p>

### What Teleport Affects

- **Any piece type**: Pawns, knights, bishops, rooks, queen â€?all fair game
...
| â˜…â˜…â˜?| King | If King gets swapped to front line, you lose |

| â˜…â˜…â˜?| Gambit-carrier queen | Queen with Gambit buff loses tempo when repositioned |

| â˜…â˜… | Rook / Knight | Important but recoverable |

| â˜?| Bishop / Pawn | Low impact. Fix these last |

<div class="callout callout-tip">


  <strong>Prep Tip</strong><br>
...
**Strategy**: Build a compact defensive formation. Keep King in back corner. When teleport hits, use Retreat to fix. Don't chase damage â€?survive the teleport turns.
...
- **King Bind** (Mandatory â€?you can't afford King being exposed)
...
<p class="schema-caption">Fortress layout (Teal area). King, Queen, Rook, Bishop inside â€?pawns sacrificed in disposable zone (Orange). Pieces inside the dashed border are teleport-proof.</p>
...
- **Fortress** (Makes a 2Ã—2 area teleport-proof)
...
- "Decoy strategy â€?leave a single pawn in front. Teleport usually swaps it with something. Keep your real formation tight in back."
...
A: No â€?only your pieces are affected.

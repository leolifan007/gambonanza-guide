...
# First 3 Turns: The Universal Safe Opening Template (Works With Any Seed in Gambonanza)
...
**Forget seeds. Forget build archetypes. This 3-turn template works on any board, with any starting roll, against any opponent. Follow it blind and you will survive to Stage 2.**

<div class="synergy-table" style="overflow-x:auto">

| Turn | Action | Rule | Why |
|------|--------|------|-----|
| 1 | Move | Push one piece two squares forward toward center | Controls central tiles, safe from early trades |
| 2 | Pick | Buy your first Gambit, any Gambit | A weak Gambit active beats a perfect Gambit sitting in the shop |
| 3 | Link | Make your Gambit interact with at least one existing piece | Establishes first synergy layer, sets up economy for turn 4+ |
...
> **Pro tip:** Record your next 5 runs. Write down exactly what you did on turns 1, 2, and 3. Then check your win rate on those runs versus runs where you deviate. The data will convince you faster than any guide can.

{{< section-divider >}}

## The Universal Template: Move-Pick-Evaluate

### Turn 1: Move (Central Control)
...
Open the shop and buy a Gambit. Any Gambit.
...
> **Pro tip:** If your turn 2 shop is truly abysmal (all F-tier Gambits with zero synergy potential), buy the cheapest one anyway. The cost of buying a bad Gambit is less than the cost of having no Gambit. You can replace it on turn 5.

{{< section-divider >}}

## 3 Common Opening Traps

### Trap 1: The Overextension Trap

You push a piece three or four squares forward on turn 1 because you want aggressive board presence. By turn 2, the opponent or the board state punishes that exposed piece. You spend turn 3 retreating. Now you are behind on both position and tempo.

**The fix:** Never move a piece more than two squares forward in the first 2 turns. Two squares is aggressive enough to claim space. Three squares is overextension.
...
### Trap 3: The Seed Superstition Trap
...
## Adaptive Branching: What to Do After Turn 3
...
- [Recommended Seeds](/recommended-seeds/) -- Community seeds for specific builds; use them alongside the template, not instead of it
- [Beginner Guide](/beginner/) -- Full walkthrough from zero to consistent wins
- [How to Play](/how-to-play/) -- The mechanics explained, including opening phase fundamentals

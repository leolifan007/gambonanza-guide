...
<div class="callout callout-verdict">
  <strong>⛔ STOP PLAYING CHESS. RIGHT NOW.</strong><br>
...
| **Board** | 4×4 to 6×6 (16-36 squares, tiny!) |
...
1. **How small the board actually is** — 4×4 is TINY (16 squares total). Every move affects the entire board state.
...
<div class="callout callout-verdict">
  ...
  On boards smaller than 6×6, defensive play = guaranteed loss. Every turn you spend "positioning" is a turn your opponent uses to corner your king. Attack first, block never.
</div>
...
|---|---|---|
| 4×4 board | Both knights forward-center | Control 60% of board by turn 3 |
...
<div class="callout callout-synergy">
  <strong>✅ THE PROMOTION MINDSET</strong><br>
...
| <span class="meta-badge meta-a">A</span> | **Double Capture** | 50 stock | Take two pieces with one move on a 4×4 board = match over in 2 turns |
...
<div class="callout callout-danger">
  <strong>❌ AVOID THESE TRAP PICKS</strong><br>
...
<div class="callout callout-danger">
  <strong>❌ THE 5 FASTEST WAYS TO LOSE</strong>
</div>
...
<div class="meta-rating">
  ...
  <span class="meta-label">Every run teaches you something. The player who wins consistently isn't the one with the best Gambits — it's the one who learned not to develop their queen on turn 2 against the shopkeeper boss.</span>
</div>

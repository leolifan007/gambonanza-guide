...
| Table | Return | Risk | Min Stock | Rating |
|---|---|---|---|---|
| **Knight's Jump** | 2Ã— (60%) / -50% (40%) | Medium | 30 | <span class="meta-badge meta-a">A</span> |
| **Bishop's Diagonal** | 1.5Ã—, varies by board state | Low | 20 | <span class="meta-badge meta-a">A</span> |

</div>

<div class="meta-rating">
  <span class="meta-badge meta-a">A</span>
  <span class="meta-label">Knight's Jump positive EV: 2Ã—0.6 + 0.5Ã—0.4 = 1.4Ã— expected return. Better than Safe Haven but with variance. Put 30% of stock here.</span>
</div>

<div class="pro-tip">
  <strong>Only 10h+ players know:</strong> Bishop's Diagonal return rate is tied to actual board position. If you control the center AND both bishops are alive, the return jumps to 2.5Ã—. This is the only investment table you can actively influence during the match.
</div>
...
| Table | Return | Risk | Min Stock | Rating |
|---|---|---|---|---|
| **Gambler's Gambit** | 5Ã— (20%) / 0 (80%) | Extreme | 20 | <span class="meta-badge meta-b">B</span> |
...
|---|---|---|---|
| **Pawn Lottery** | 1.5Ã— bet | Bet exactly 37 stock | Stock below 50 |

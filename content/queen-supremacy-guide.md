...
|-------|-----------------|-----|
| 4×4 | 2-3 | Overkill, but Teleport combo ends game in 2 turns |
| 5×5 | 2-4 | Sweet spot — deploy early, stack Gambits |
| 6×6+ | 3-5 | Clear a lane first, then Queen takes over |

> **Rule:** Never turn 1 on 5×5+. Deploy Knight/Bishop first to open a lane.

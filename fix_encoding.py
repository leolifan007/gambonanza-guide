#!/usr/bin/env python3
"""
Encoding Fix Script for Gambonanza Guide
...
def fix_emoji_garbage(text: str) -> str:
    ...
    # Common emoji replacements based on context
    replacements = {
        # Logo icon (likely a game piece or die)
        '鈾?': '🎲',
...
# Check for non-UTF-8 files (requires 'file' command)
if command -v file &> /dev/null; then
    find . -name "*.md" -o -name "*.html" -o -name "*.toml" | while read file; do
...
echo "✅ All files appear to be properly encoded"
exit 0
"""
